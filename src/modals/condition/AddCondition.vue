<script setup>
import { condtionStore, navigationStore } from '../../store/store.js'
</script>

<template>
	<NcModal v-if="navigationStore.modal === 'addCondition'" ref="modalRef" @close="navigationStore.setModal(false)">
